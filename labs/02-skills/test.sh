...
# RUN_LIVE is set to 1, and they read and write the Skill Registry and call
# Gemini.
set -euo pipefail
cd "$(dirname "$0")"
...
if [[ "${RUN_LIVE:-0}" == "1" ]]; then
  ...
  echo "Running the live tests, which register the packaged skill and run the graph"
